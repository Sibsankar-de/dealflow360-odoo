...
export const DealHealthSummaryCards: React.FC<DealHealthSummaryCardsProps> = ({
  ...
  const cards = [
    {
      id: "stalled",
      title: "Stalled / Idle Deals",
      count: kpi.stalledDealsCount || 0,
      subtext: "No activity / stalled",
    ...
    {
      id: "expiring",
      title: "Expiring & Overdue",
      count: (kpi.expiringDealsCount ?? 0) + (kpi.expiredDealsCount ?? 0),
      subtext: "<= 2 days or overdue",
    ...
    },
    {
      ...
      count: kpi.deliveryRisksCount || 0,
      subtext: "Pending backorders",
    ...
    },
    {
      ...
      count: (kpi.discountAnomaliesCount || 0) + (kpi.highRiskApprovalsCount || 0),
      subtext: "In negotiation / draft",
